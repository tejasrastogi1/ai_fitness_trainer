...
const ProfilePage = () => {
  ...
  const handleDeletePlan = async (planId: string) => {
    try {
      ...
      // If we deleted the currently selected plan, reset the selection
                ...
                <div key={plan._id} className="flex items-center gap-2">
                  ...
                  {showDeleteButton === plan._id && (
                    <Button
                      ...
                      size="sm"
                      className="ml-4 bg-transparent border border-border text-muted-foreground hover:bg-red-500/20 hover:border-red-500/50 hover:text-red-500 transition-colors"
                    >
